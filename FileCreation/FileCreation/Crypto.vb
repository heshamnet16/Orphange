...
Public Class Crypto
    ...
    Sub New()
        ...
        TripleDes.Key = TruncateHash("Yousef_Bin_Jacop", TripleDes.KeySize \ 8)
    ...
    Public Function DecryptString(ByVal encryptedtext As String) As String
        ...
        Dim encryptedBytes() As Byte = System.Text.Encoding.Unicode.GetBytes(encryptedtext)
        ...
        Return System.Text.Encoding.Unicode.GetString(ms.ToArray)
    End Function
    Public Function EncryptBytes(ByVal bytes() As Byte) As Byte()
        ' Convert the plaintext string to a byte array. 
        ' Create the stream. 
        Dim ms As New System.IO.MemoryStream
        ' Create the encoder to write to the stream. 
        ...
        Return ms.ToArray
    End Function
    Public Function DecryptBytes(ByVal bytes() As Byte) As Byte()
        ' Create the stream. 
        Dim ms As New System.IO.MemoryStream
        ' Create the decoder to write to the stream. 
